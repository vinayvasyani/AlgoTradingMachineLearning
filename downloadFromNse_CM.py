...
monthNumbers = range(8, 12, 1)

listOfDays = range(0, 31, 1)

pathToSave = "/Users/vinay/PycharmProjects/QuantTradingWithML/Download/src/downloadedFiles/nse/cm/"
secType = "CM"
for year in listOfYears:
    for monthInd in monthNumbers:
        for dayOfMonth in listOfDays:
            ...
            print nseURL
            saveAs = "cm" + str(day) + month + str(year) + "bhav.csv.zip"
